...
our %config = (
    "AR" => "/cygdrive/e/ohos_ndk/llvm/bin/llvm-ar.exe",
    "ARFLAGS" => [
        "qc"
    ],
    "CC" => "/cygdrive/e/ohos_ndk/llvm/bin/clang.exe",
    "CFLAGS" => [
        "--target=aarch64-linux-ohos --sysroot=E:/ohos_ndk/sysroot -fPIC"
    ],
    "CPPDEFINES" => [],
    "CPPFLAGS" => [],
    "CPPINCLUDES" => [],
    ...
    "LDFLAGS" => [
        "--target=aarch64-linux-ohos --sysroot=E:/ohos_ndk/sysroot"
    ],
    "LDLIBS" => [],
    "PERL" => "/usr/bin/perl",
    "RANLIB" => "/cygdrive/e/ohos_ndk/llvm/bin/llvm-ranlib.exe",
    "RC" => "windres",
    "RCFLAGS" => [],
    "afalgeng" => "",
    "api" => "30000",
    ...
    "openssl_sys_defines" => [],
    "openssldir" => "",
    "options" => "--prefix=E:/HarmonyOs/Worker/ProjectFiles/freerdp-harmonyos/native-install/deps/arm64-v8a/openssl no-acvp-tests no-afalgeng no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-ktls no-loadereng no-makedepend no-md2 no-msan no-rc5 no-sctp no-shared no-ssl3 no-ssl3-method no-tests no-trace no-ubsan no-unit-test no-uplink no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
    "patch" => "15",
    ...
    "perlargv" => [
        "linux-aarch64",
        "--prefix=E:/HarmonyOs/Worker/ProjectFiles/freerdp-harmonyos/native-install/deps/arm64-v8a/openssl",
        "no-tests",
        "no-shared"
    ],
    "perlenv" => {
        ...
        "BUILDFILE" => undef,
        "CC" => "/cygdrive/e/ohos_ndk/llvm/bin/clang.exe",
        "CFLAGS" => "--target=aarch64-linux-ohos --sysroot=E:/ohos_ndk/sysroot -fPIC",
        "CPP" => undef,
        "CPPDEFINES" => undef,
        "CPPFLAGS" => undef,
        "CPPINCLUDES" => undef,
        ...
        "HASHBANGPERL" => undef,
        "LD" => undef,
        "LDFLAGS" => "--target=aarch64-linux-ohos --sysroot=E:/ohos_ndk/sysroot",
        "LDLIBS" => undef,
        "MT" => undef,
        "MTFLAGS" => undef,
...
unless (caller) {
    ...
    use lib '/cygdrive/e/HarmonyOs/Worker/ProjectFiles/freerdp-harmonyos/native-src/openssl-3.0.15/util/perl';
    use OpenSSL::fallback '/cygdrive/e/HarmonyOs/Worker/ProjectFiles/freerdp-harmonyos/native-src/openssl-3.0.15/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/cygdrive/e/HarmonyOs/Worker/ProjectFiles/freerdp-harmonyos/native-src/openssl-3.0.15/Configurations';
        use gentemplate;
