...
BEGIN {
    ...
    require '/cygdrive/e/HarmonyOs/Worker/ProjectFiles/freerdp-harmonyos/native-src/openssl-3.0.15/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/cygdrive/e/HarmonyOs/Worker/ProjectFiles/freerdp-harmonyos/native-src/openssl-3.0.15/test/fips-and-base.cnf';
    shift;
