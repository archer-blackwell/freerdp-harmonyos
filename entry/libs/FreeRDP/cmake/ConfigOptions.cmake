...
# OpenHarmony file-open observation hook in the drive (rdpdr) client channel.
# When enabled, the channel exports ohos_freerdp_set_file_open_callback() so a
# wrapper library can observe plain read-only FILE_OPEN requests issued by the
# server against the redirected drive (e.g. Explorer double-click) and open the
# file locally on the client device. Purely observational: the IRP is always
# completed normally. Default OFF, does not affect any other platform.
